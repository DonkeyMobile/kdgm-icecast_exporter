...
A [Prometheus](https://prometheus.io/) exporter that scrapes stats from [Icecast](http://icecast.org/) streaming media server via its JSON API (`/status-json.xsl`, requires Icecast 2.4.0+).
